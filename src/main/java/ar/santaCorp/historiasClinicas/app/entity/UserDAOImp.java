...
public class UserDAOImp implements IUserDAO{
	...
	public ArrayList<UserVO> getUsers()
	{
		...
		ArrayList fileLines = FileManager.getFileLines("src/main/resources/db/sysUsers/sysadminList.json");
	...
	{
		UserVO userVo;
		ArrayList fileLines = FileManager.getFileLines("src/main/resources/db/session/loggedUser/logedUser.json");
		if(fileLines==null)
		{
			return null;
		}else
	...
	public boolean createUserSession(UserVO userVo)
	{
		...
		FileManager.setFile("src/main/resources/db/session/loggedUser/logedUser.json", jsonUserVo);
		System.out.println("--------------------------------");
	...
	public boolean deleteUserSession()
	{
		...
		System.out.println("==========================");
		System.out.println("==========================");
		FileManager.deleteFile("src/main/resources/db/session/loggedUser/logedUser.json");
		return true;
	}
}
