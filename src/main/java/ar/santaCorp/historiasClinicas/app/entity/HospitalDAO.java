...
public class HospitalDAO implements IHospitalDAO {
	...
	public ArrayList<HospitalVO> getHospitals() {
		ArrayList hospitalsPaths = FileManager.listDirectoryFiles("src/main/resources/db/hospitals/hospital/");
	...
	public HospitalVO create(HospitalVO hospitalVo) {
		...
		FileManager.setFile("src/main/resources/db/hospitals/hospital/hospital"+id+".json", jsonHospitalVo);
	...
	public boolean createOrUpdateHospitalsFromDataSource()
	{
		...
		ArrayList fileLines = FileManager.getFileLines("src/main/resources/db/hospitals/hospitals.json");
		...
		for (int i = 0; i < fileLines.size(); i++) {
			...
			String pathFileHospital = "src/main/resources/db/hospitals/hospital/hospital"+tmpHospitalVo.getId()+".json";
